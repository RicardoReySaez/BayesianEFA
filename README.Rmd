...
[![CRAN status](https://www.r-pkg.org/badges/version/BayesianEFA)](https://CRAN.R-project.org/package=BayesianEFA)
...
You can install the development version of BayesianEFA from [GitHub](https://github.com/RicardoReySaez/BayesianEFA) with:
...
Since `BayesianEFA` includes custom C++ functions, macOS users must configure the R compilation toolchain. Following the recommendations from the [latent](https://github.com/Marcosjnez/latent) package, we suggest using `macrtools` by James Balamuta to automate this setup:
